<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportPage.aspx.cs" Inherits="ReportPage" MasterPageFile="~/Educator/Educator.master" %>
        ...
        <fieldset class="form-horizontal">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <asp:TextBox ID="txtApprover"  Enabled="false" CssClass="input-xlarge" name="exp" ng-model="user.exp" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:TextBox ID="txtGrade" CssClass="input-xlarge" name="exp" ng-model="user.exp" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:TextBox ID="txtStage" CssClass="input-xlarge" name="exp" ng-model="user.exp" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:TextBox ID="txtReport" name="v" CssClass="input-xlarge publishDate" Rows="5" TextMode="MultiLine" runat="server" required></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-actions">
                <asp:Button ID="btnSave" class="btn btn-primary" OnClick="btnSave_Click" type="submit" runat="server" Text="Kaydet" />
            </div>

        </fieldset>


        <h1 style="float: left; width: 50%;">Öğrenci Raporları</h1>
        <div align="center">  
                ...
                <asp:Repeater ID="RepetearReports" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("Date") %> </td>
                            <td><a href="<%= Page.ResolveUrl(Urls.Educator.Report) %>?StudentId=<%# Eval("StudentId") %>&ActivityId=<%# Eval("ActivityId") %>" class="view-link">Görüntüle</a>   </td>
